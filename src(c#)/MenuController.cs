...
public static class MenuController
{
	...
	private static readonly string [] [] _menuStructure = {
        // MAIN_MENU 
        new string[] {"PLAY","SETUP","MUSIC","SCORES","OPTION","MUTE","QUIT","CHANGE BG"},
	...
	public const int DEPLOYING_MENU = 4;
	...
	//private const int TURN_OFF = 3;
	//private const int TURN_ON = 4;
	...
	{
		bool handled = false;
		handled = HandleMenuInput(BG_MENU, 1, 5);
	...
	{
		bool handled = false;
		handled = HandleMenuInput (OPTION_MENU, 1, 4);
	...
	private static void PerformBGChangeAction (int button)
	{
		...
		{
		case BG_PIC1_BUTTON:
			MenuController.BackgroundChoice = 0 ;
			break;
		case BG_PIC2_BUTTON:
			MenuController.BackgroundChoice = 1;
			break;
		case BG_PIC3_BUTTON:
			MenuController.BackgroundChoice = 2;
			break;
	...
	private static void PerformGameMenuAction (int button)
	{
		...
		case GAME_MENU_SURRENDER_BUTTON:
			if (MessageBox.Show ("Are you sure you want to surrender?", "SURRENDER", MessageBoxButtons.YesNo) == DialogResult.Yes) {
...
private static void PerformBGCHANGEMenuAction (int button)
{

	switch (button) {
	case BG_PIC1_BUTTON:
		GameResources.GameImage ("battleship1.jpg");
		break;
	case BG_PIC2_BUTTON:
        GameResources.GameImage  ("battleship2.jpg");
		break;
